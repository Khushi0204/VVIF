...
const Missions = () => {
      ...
      <section className="dark:bg-secondary-foreground rounded-lg shadow-lg py-12 bg-orange-200">
        <div className="container mx-auto px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
            {/* First row */}
            <div className="bg-white dark:bg-card-foreground rounded-lg p-6 shadow-md">
              <img
                src={edu}
                alt="Education"
                className="h-[200px] md:h-[250px] object-cover rounded-lg mb-4 mx-auto"
              />
              ...
              <a
                href="/DonateNow"
                className="bg-orange-400 text-accent-foreground hover:bg-accent/80 rounded-full px-4 py-2 md:px-6 md:py-3 mt-4 inline-block"
              >
                Donate
              </a>
            </div>
 ...
 {/* More content */}
          ...
          {/* Second row of cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-6">
            {/* Additional cards following the same structure */}
            <div className="bg-white dark:bg-card-foreground rounded-lg p-6 shadow-md">
              <img
                src={kausal}
                alt="kausal"
